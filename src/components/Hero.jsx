    ...
    <section className="flex items-center pt-24 pb-16 sm:pt-28 sm:pb-20 px-6 max-w-7xl mx-auto min-h-[calc(100vh-80px)]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center w-full">
        ...
        >
          ...
          <motion.h1
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold leading-[1.05] mb-3"
          ...
          <motion.p
            className="text-base sm:text-lg md:text-xl font-display font-semibold text-gray-400 uppercase tracking-widest mb-6"
          ...
          <motion.p
            className="text-base sm:text-xl text-gray-400 max-w-lg mb-8 sm:mb-10 leading-relaxed font-light"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Link to="/contact">
              <motion.button
                className="gradient-bg px-6 sm:px-8 py-3 sm:py-4 rounded-xl flex items-center space-x-3 text-white font-semibold shadow-lg shadow-purple-500/20"
            ...
            <motion.a
              ...
              className="bg-white/5 border border-white/10 px-6 sm:px-8 py-3 sm:py-4 rounded-xl flex items-center space-x-3 text-white font-semibold hover:bg-white/10 hover:border-purple-500/30 transition-all duration-300"
        ...
        >
          <div className="relative z-10 w-full max-w-[260px] sm:max-w-[300px] lg:max-w-[320px]">
            <div className="rounded-[2.5rem] overflow-hidden border border-white/10 bg-[#111] p-3 group relative">
              ...
              {/* FIX: responsive image height — was h-[420px] at all sizes which caused overflow on mobile */}
              <img
